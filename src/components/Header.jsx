      ...
      <header className="flex justify-between items-center px-3 mxa-w-6xl mx-auto">
        ...
        <div>
          <ul className="flex space-x-10">
            ...
            <li className={`cursor-pointer py-3 text-sm font-semibold text-gray-400 border-b-[3px] border-b-transparent ${pathMatchRoute("/sign-in") && "text-[color:black] border-b-red-600"}`} onClick={()=>navigate("/sign-in")}>Sign In</li>
          </ul>
        </div>
      </header>
    </div>
